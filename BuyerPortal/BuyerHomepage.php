...
<head>
	...
	<title>Farmacraft Homepage</title>
...
<body>
	...
	<div class="instaid">
		<div class="text"><a href="#" style="color:black;">@Farmacraft</a></div>
		<div class="gmailid">
			<a href="#" class="hypher" style="color:black;">contact@Farmacraft.com</a></div>

	</div>


	<div class="copy">
		<h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by <p hidden>https://<p>www.koduruyaswanthreddy.me/</h5>
	</div>
</body>
